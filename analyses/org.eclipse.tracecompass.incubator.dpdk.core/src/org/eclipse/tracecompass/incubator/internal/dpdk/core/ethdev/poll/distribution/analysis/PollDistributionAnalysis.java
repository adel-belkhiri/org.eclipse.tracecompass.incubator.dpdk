...
/**
 * Dpdk polls distribution analysis is an on-demand analysis that calculates the number of packets
 * retrieved in a single call to rte_eth_rx_burst(). The poll distribution is calculated per port queue only.
 *
