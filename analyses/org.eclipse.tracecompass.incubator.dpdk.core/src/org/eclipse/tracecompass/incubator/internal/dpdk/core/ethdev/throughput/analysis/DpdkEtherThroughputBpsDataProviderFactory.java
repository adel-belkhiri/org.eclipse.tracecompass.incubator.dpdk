...
/**
 * Factory to create instances of the {@link DpdkEtherThroughputDataProvider}.
 *
 * @author Adel Belkhiri
 */
public class DpdkEtherThroughputDataProviderFactory implements IDataProviderFactory {
    ...
    private static final IDataProviderDescriptor DESCRIPTOR = new DataProviderDescriptor.Builder()
            .setId( DpdkEtherThroughputDataProvider.ID)
            .setName("Dpdk Ethernet Throughput") //$NON-NLS-1$
            .setDescription("XY chart illustrating the throughput of DPDK Ethernet NIC ports") //$NON-NLS-1$
    ...
    public @Nullable ITmfTreeXYDataProvider<? extends ITmfTreeDataModel> createProvider(ITmfTrace trace) {
        ...
        if (traces.size() == 1) {
            return DpdkEtherThroughputDataProvider.create(trace);
        }
        return TmfTreeXYCompositeDataProvider.create(traces, DpdkEtherThroughputDataProvider.PROVIDER_TITLE, DpdkEtherThroughputDataProvider.ID);
    }
