 ...
 */
public class DpdkEtherThroughputDataProvider extends AbstractTreeCommonXDataProvider<DpdkEthdevAnalysisModule, TmfTreeDataModel>
        implements IOutputStyleProvider {

    /**
     * Extension point ID.
     */
    public static final String ID = "org.eclipse.tracecompass.incubator.dpdk.ethdev.throughput.dataprovider"; //$NON-NLS-1$

    /**
     * Title used to create XY models for the {@link DpdkEtherThroughputDataProvider}.
     */
    ...
    /**
     * Create an instance of {@link DpdkEtherThroughputDataProvider}. Returns a null
     * instance if the analysis module is not found.
     *
     * @param trace
     *            A trace on which we are interested to fetch a model
     * @return A {@link DpdkEtherThroughputDataProvider} instance. If analysis module is not
     *         found, it returns null
     */
    public static @Nullable DpdkEtherThroughputDataProvider create(ITmfTrace trace) {
        ...
        if (module != null) {
            module.schedule();
            return new DpdkEtherThroughputDataProvider(trace, module);
        }
        return null;
    }
     ...
     * Constructor
     */
    private DpdkEtherThroughputDataProvider(ITmfTrace trace, DpdkEthdevAnalysisModule module) {
        super(trace, module);
    }
     ...
     * @return
     *          Number of packets received or sent from the RX/TX queue
     */
