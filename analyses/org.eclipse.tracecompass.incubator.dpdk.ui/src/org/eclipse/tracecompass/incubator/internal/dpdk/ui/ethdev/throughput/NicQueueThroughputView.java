...
import org.eclipse.tracecompass.incubator.internal.dpdk.core.ethdev.throughput.analysis.DpdkEtherThroughputDataProvider;
...
/**
 * This view shows packet reception and transmission rates per port queue
 *
...
public class NicQueueThroughputView extends TmfChartView {
     ...
     */
    public static final String ID = "org.eclipse.tracecompass.incubator.dpdk.ethdev.throughput.view"; //$NON-NLS-1$
    ...
    protected TmfXYChartViewer createChartViewer(Composite parent) {
        ...
        return new TmfFilteredXYChartViewer(parent, settings, DpdkEtherThroughputDataProvider.ID);
    }

    @Override
    protected @NonNull TmfViewer createLeftChildViewer(@Nullable Composite parent) {
        return new AbstractSelectTreeViewer2(parent, 1, DpdkEtherThroughputDataProvider.ID) {
            @Override
