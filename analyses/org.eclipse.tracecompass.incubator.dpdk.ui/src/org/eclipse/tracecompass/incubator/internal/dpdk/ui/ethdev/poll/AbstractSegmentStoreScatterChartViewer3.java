 ...
 * @since 4.1
 */
public class AbstractSegmentStoreScatterChartViewer3 extends TmfFilteredXYChartViewer {

    private static final Format FORMAT = new DecimalUnitFormat();
     ...
     */
    public AbstractSegmentStoreScatterChartViewer3(Composite parent, TmfXYChartSettings settings) {
     ...
     */
    public AbstractSegmentStoreScatterChartViewer3(Composite parent, TmfXYChartSettings settings, String analysisId) {
